...
<body>
	...
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/kpi/chopingBiz/">切片工站每日绩效</a></li>
		<li class="active"><a href="${ctx}/kpi/chopingBiz/month">切片工站月度绩效</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="chopingBiz" action="${ctx}/kpi/chopingBiz/month" method="post" class="breadcrumb form-search">
		...
		<a href="${ctx}/kpi/chopingBiz/export?isMonth=1">
