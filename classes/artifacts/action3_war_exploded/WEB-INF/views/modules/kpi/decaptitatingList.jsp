...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/kpi/decaptitating/">去头工站日度绩效</a></li>
		<li><a href="${ctx}/kpi/decaptitating/month">去头工站月度绩效</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="decaptitating" action="${ctx}/kpi/decaptitating/" method="post" class="breadcrumb form-search">
		...
		<a href="${ctx}/kpi/decaptitating/export">
