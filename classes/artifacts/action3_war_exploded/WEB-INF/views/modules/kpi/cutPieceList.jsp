...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/kpi/cutPiece/">开片工站日度绩效</a></li>
		<li><a href="${ctx}/kpi/cutPiece/month">开片工站月度绩效</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cutPiece" action="${ctx}/kpi/cutPiece/" method="post" class="breadcrumb form-search">
		...
		<a href="${ctx}/kpi/cutPiece/export">
