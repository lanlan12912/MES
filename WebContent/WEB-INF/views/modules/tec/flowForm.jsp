...
<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/tec/flow/form?id=${flow.id}">流程${not empty flow.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="flow" action="${ctx}/tec/flow/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="flowDesc" htmlEscape="false" maxlength="50" />
			</div>
		</div>
