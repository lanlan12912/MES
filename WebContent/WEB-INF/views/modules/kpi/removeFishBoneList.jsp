...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/kpi/removeFishBone/">挑刺工站日度绩效</a></li>
		<li><a href="${ctx}/kpi/removeFishBone/month">挑刺工站月度绩效</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="removeFishBone" action="${ctx}/kpi/removeFishBone/" method="post" class="breadcrumb form-search">
		...
		<a href="${ctx}/kpi/removeFishBone/export">
